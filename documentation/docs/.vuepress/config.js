...
module.exports = {
    ...
    description: "Documenation Site for AuthCompanion - An effortless, open source, token-based user management server - well suited for modern web projects.",
    ...
    theme: defaultTheme({
      ...
      sidebar: {
        "/": [
          {
            text: "📚 The Guide",
            children: ["/guide/gettingstarted.md", "/guide/explore.md", "/guide/configuration.md", "/guide/webforms.md", "/guide/authapi.md"],
          },
        ],
        "/contributing/": [
          {
